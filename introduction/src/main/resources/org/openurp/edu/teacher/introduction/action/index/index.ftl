...
[#list categories as category]
   [@b.a href="introduction!search?introduction.category.id="+category.id target="content"]${category.name}[/@]
[/#list]

[@b.div id="content" href="introduction!search?introduction.category.id="+categories?first.id/]
</div>
[@b.foot/]